...
export class Convert {
  public static toSearchReponse(json: string): SearchReponse {
      return cast(JSON.parse(json), r("SearchReponse"));
  }

  public static searchReponseToJson(value: SearchReponse): string {
      return JSON.stringify(uncast(value, r("SearchReponse")), null, 2);
  }
}
